...
def gotoTable(self):
    ...
    goal.target_pose.pose = Pose(position = Point(**tables['table' + str(table_index)]['location']['position']),
        orientation = Quaternion(**tables['table' + str(table_index)]['location']['orientation']))
